...
const Women = () => {
    ...
    const menHoodies = hoodies.filter(hoodie => hoodie.genre === 'women');
    ...
    return (
        <div className={`${styles.flexCenter} flex-col mb-16`}>
            <div className={`${styles.innerWidth} ${styles.flexCenter} flex-col text-primary-black p-8 m-4`}>
                <h1 className={`${styles.h1Section} text-center mb-4`}>Women’s hoodie</h1>
                <p className={` text-center mb-8`}>Discover the latest trends in women’s hoodies</p>
